...
const iconStrokeClass = "w-3.5 h-3.5 shrink-0 text-[color:var(--color-text-muted)]";

export const CATEGORY_ICONS: Record<CategoryKey, React.ReactNode> = {
  "数据故事": (
    <svg className={iconStrokeClass} viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function FileIcon({ isJsx }: { isJsx: boolean }) {
  ...
  return (
    <svg className="w-3.5 h-3.5 shrink-0 text-[color:var(--color-text-muted)]" viewBox="0 0 16 16" fill="currentColor">
